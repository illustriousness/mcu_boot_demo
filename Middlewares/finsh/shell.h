...
#endif
    struct finsh_syscall *syscall_table_begin;
    struct finsh_syscall *syscall_table_end;
    int8_t (*getchar)(void);
};
...
// int finsh_system_init(struct finsh_shell *new_shell,const void *begin, const void *end, int8_t (*getchar)(void));
